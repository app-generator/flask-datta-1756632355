...
class Applicationform(db.Model):
    ...
    full name = db.Column(db.String(255),  nullable=True)
    cnic = db.Column(db.String(255),  nullable=True)
    gender = db.Column(db.String(255),  nullable=True)
    address = db.Column(db.Text, nullable=True)
    cell # = db.Column(db.Integer, nullable=True)
    date of birth = db.Column(db.DateTime, default=db.func.current_timestamp())
